...
export const DashboardPage: React.FC = () => {
    ...
    let greeting = content.greeting.evening;
    if (hour < 12) greeting = content.greeting.morning;
    else if (hour < 18) greeting = content.greeting.afternoon;

    const displayName = user?.displayName;
    const displayGreeting = displayName ? `${greeting}, ${displayName}!` : content.greeting.fallback;
            ...
            <div className="max-w-6xl mx-auto px-12 pt-12 relative z-10 pb-20">
                <div className="mb-12">
                    <div className="flex justify-between items-end mb-6">
                        <h2 className="text-2xl font-bold text-mcd-black">{content.sections.tools}</h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    <div>
                        <h2 className="text-2xl font-bold text-mcd-black mb-6">{content.sections.performance}</h2>
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-mcd-black mb-6">{content.sections.news}</h2>
